...
SUMMERNOTE_CONFIG = {
    ...
    'summernote': {
        ...
        # Use proper toolbar configuration
        'toolbar': [
            ['style', ['style']],
    ...
    # Require CSRF token for all requests
    'attachment_require_authentication': True,
    
    # Set attachment upload directory
...
# Allow Django to serve media files with proper CORS headers
